...
insert into [Tag] ([Id], [Name], [isActive])
values (1, 'C#', 1), (2, 'JavaScript', 1), (3, 'Funny', 1), (4, 'Scary', 1);
set identity_insert [Tag] off

set identity_insert [UserProfile] on
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId, IsActive) values (1, 'rsandwith0', 'Reina', 'Sandwith', 'rsandwith0@google.com.brx', '2020-04-23', 'https://robohash.org/numquamutut.png?size=150x150&set=set1', 1, 'jpuhyzaicsokywncxveknzowfpdu', 1);
